          ...
          {getFilteredHotels().flatMap((city) =>
            city.rating.flatMap((rating) =>
              rating.hotels.map((hotel) => (
                <div key={hotel.hotelName} className='relative border md:flex lg:flex rounded-lg hover:shadow-xl bg-white'>
                  <div className='md:w-4/12 lg:w-4/12 flex justify-center items-center'>
                    <img src={hotel.hotelImage} alt={hotel.hotelName} className='mx-2 w-full rounded my-2 h-56 object-cover' />
                  </div>
